...
git filter-branch --force --tree-filter '
  if [ -f MCP/server/src/index.ts ]; then
    sed -i "s/sk_15d6f23c93bf4d768f210fbbfc07f68105f0870aa8aa0198/YOUR_ELEVENLABS_API_KEY/g" MCP/server/src/index.ts
    sed -i "s/AIzaSyC9yaQUsLTxUEyxv6i8M1IcMPkIWJto6RY/YOUR_GOOGLE_API_KEY/g" MCP/server/src/index.ts
  fi
' --prune-empty --tag-name-filter cat -- --all ^71234a9
...
git filter-branch --force --tree-filter '
  if [ -f MCP/server/src/index.ts ]; then
    sed -i.bak "s/sk_15d6f23c93bf4d768f210fbbfc07f68105f0870aa8aa0198/YOUR_ELEVENLABS_API_KEY/g" MCP/server/src/index.ts
    sed -i.bak "s/AIzaSyC9yaQUsLTxUEyxv6i8M1IcMPkIWJto6RY/YOUR_GOOGLE_API_KEY/g" MCP/server/src/index.ts
...
git log -p --all | grep -E "(sk_15d6f23c93bf4d768f210fbbfc07f68105f0870aa8aa0198|AIzaSyC9yaQUsLTxUEyxv6i8M1IcMPkIWJto6RY)"
